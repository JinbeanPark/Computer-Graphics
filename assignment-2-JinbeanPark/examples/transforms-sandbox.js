...
export class Transforms_Sandbox extends Transforms_Sandbox_Base {
    ...
    display(context, program_state) {
        ...
        model_transform = model_transform.times(Mat4.scale(1, 2, 1)).times(Mat4.translation(0, -2, 0));
        //model_transform = model_transform.times(Mat4.translation(0, -2, 0)).times(Mat4.scale(1, 2, 1));
        ...
        model_transform = model_transform//.times(Mat4.rotation(Math.PI / 6, 0, 1, 0))
